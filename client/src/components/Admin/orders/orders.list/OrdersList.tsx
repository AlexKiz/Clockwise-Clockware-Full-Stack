...
<<<<<<<< HEAD:client/src/components/Admin/orders/list/OrdersList.tsx
import './orders-list.css';
========
import '../orders.list/orders-list.css';
>>>>>>>> d3f3e75 (fixed according comments):client/src/components/Admin/orders/orders.list/OrdersList.tsx
