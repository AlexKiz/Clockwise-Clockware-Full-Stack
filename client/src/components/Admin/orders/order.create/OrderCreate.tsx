...
<<<<<<<< HEAD:client/src/components/Admin/orders/create/OrderCreate.tsx
...
import {RESOURCE, URL} from '../../../../data/constants/routeConstants';
import {format} from 'date-fns';
>>>>>>>> d3f3e75 (fixed according comments):client/src/components/Admin/orders/order.create/OrderCreate.tsx
